Config = {}
Config.Prefix = '^5[^FiveCore^5] ^3'
-- Default key is 244, which is "M"  |  To change the button check out https://docs.fivem.net/game-references/controls/ for key ids.
Config.MenuButton = 244

-- 0 = Left, 1 = Right. Which side the NativeUI is on.
Config.Orientation = 1

-- true = enabled, false = disabled.
Config.VehicleMenu = true

Config.WaypointTeleport = true -- Can you teleport to waypoint? true = yes, false = no
Config.VehicleSpawner = true -- Can you spawn vehicles? true = yes, false = no
Config.WeaponMenu = true -- Can you use weapons menu? true = yes, false = no
Config.EmotesMenu = true -- Can you use emotes menu? true = yes, false = no
Config.ChangePed = true -- Can you use ped menu? true = yes, false = no
Config.FirstResponderMenu = true -- Can you use the First Responder menu? true = yes, false = no
Config.DisplayTrafficManager = true -- Can you use LEO Traffic Manager? true = yes, false = no (controls ai only)

Config.HighPingKick = true -- Kick Users with high ping. true = yes, false = no
Config.PingLimit = 400 -- Ping limit before kicked.
Config.AFKKick = true -- Kick users afk. true = yes, false = no
Config.AFKTime = 300 -- How long until kicked. (In seconds, default 300 (5 minutes))
Config.KickWarning = true -- Warn them before being kicked if they don't start moving in few seconds.
Config.KickIfNoSteam = true -- Self explainable
Config.Admins = {"admin", "superadmin", "moderator"} -- ACE Groups with permissions. (Not done, please add ace fivecore.admin to grant permissions for now)
Config.DiscordLogs = false -- Set to your discord webhook or set to false to disable.
Config.BanSync = false -- Checks SQL if a ban is added. Use only if you have more then 1 server
Config.BanCommand = true -- Command? true = yes, false = no
Config.OfflineBanCommand = true -- Command? true = yes, false = no
Config.BanHistoryCommand = true -- Command? true = yes, false = no
Config.UnbanCommand = true -- Command? true = yes, false = no
Config.SearchCommand = true -- Command? true = yes, false = no
Config.Lang = "en" -- (ADMIN ONLY!!!!!!!!! Menu is not translated (yet)). Options: fr, en
Config.DiscordInvite = "https://discord.gg/" -- Discord Invite
Config.AnnouncementHeader = '~b~[~p~Announcement~b~]'
Config.AnnouncementPlacement = .3 -- Set to 0 for top or .3 for middle of screen
Config.AnnounceDisplayTime = 15 -- How many seconds should announcements display for?
Config.Revive_Delay = 60 -- Set to 0 to disable
Config.Respawn_Delay = 30 -- Set to 0 to disable
