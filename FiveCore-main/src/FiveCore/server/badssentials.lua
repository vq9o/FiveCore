...
RegisterServerEvent("FiveCore:Peacetime")
RegisterServerEvent("FiveCore:AOP")
RegisterServerEvent("FiveCore:Revive")
RegisterServerEvent("FiveCore:Respawn")
AddEventHandler("FiveCore:Peacetime", function()
  peacetime = not peacetime;
  TriggerClientEvent('Badssentials:SetPT', -1, peacetime);
end)
AddEventHandler("FiveCore:AOP", function(aop)
  currentAOP = aop
  TriggerClientEvent('Badssentials:SetAOP', -1, currentAOP);
end)
AddEventHandler("FiveCore:Revive", function(id)
  TriggerClientEvent('Badssentials:RevivePlayer', id);
end)
AddEventHandler("FiveCore:Respawn", function(id)
  TriggerClientEvent('Badssentials:RespawnPlayer', id);
end)
AddEventHandler("FiveCore:Announce", function(message)
  TriggerClientEvent('Badssentials:Announce', -1, message);
end)
